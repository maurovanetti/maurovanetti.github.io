...
{% include figure.html file="analfabetismo-funzionale/abolizione-suffragio-universale.jpeg" 
   ...
   caption="Idee di destra espresse in una pagina che si reputa di sinistra, con tanto di arcobaleno LGBT nell’avatar: abolire il suffragio universale (fascismo o monarchia assoluta), dileggio del popolo che fa errori ortofragici<!-- l'ho scritto sbagliato di proposito-->, proibizione per le masse di discutere di questioni di Sanità pubblica durante una pandemia" %}
